...
class NetworkManager {
    ...
    static func fetchData(url: String, complection: @escaping (_ courses: [Course]) -> ()) {
    ...
    static func uploadImage(url: String) {
        ...
        let image = UIImage(named: "dragon")!
        let httpHeaders = ["Authorization": "Client-ID 722e57adb1cf734"]
